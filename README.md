# [SOLVED] Terminal-Error-Zsh-Permission-Denied-Startup-Sh
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/terminal-error-zsh-permission-denied-startup-sh)
>
...
Check if the script has execute permissions by running `chmod +x startup.sh` in the terminal.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/terminal-error-zsh-permission-denied-startup-sh)**
